...
python3 benchmarks/benchmark_throughput.py   --model /mnt/bn/siqi-sparse-rl/mnt/siqi_nas/HuggingFace-Download-Accelerator/hf_hub/models--Qwen--Qwen2.5-7B-Instruct   --backend vllm   --dataset-name hf   --dataset-path AI-MO/aimo-validation-aime   --hf-split train   --num-prompts 32 --enable-speculative
