...
#VLLM_NVTX_SCOPES_FOR_PROFILING=1 nsys profile --trace-fork-before-exec=true --cuda-graph-trace=node --delay=200 --duration=10 -o self_spec_buggy_aime24.nsys.rep 
#VLLM_NVTX_SCOPES_FOR_PROFILING=1 nsys profile --trace-fork-before-exec=true --cuda-graph-trace=node --delay=200 --duration=10 -o self_spec_tp1_aime24_after_update_no_array.nsys.rep -f true 
