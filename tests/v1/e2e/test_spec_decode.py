...
def test_ngram_and_suffix_correctness(
    ...
    should be the same when using ngram or suffix speculative decoding.
    """
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("eagle3", "meta-llama/Llama-3.1-8B-Instruct",
          "yuhuili/EAGLE3-LLaMA3.1-Instruct-8B", 1), False, False),
        pytest.param(
        ...
        (("eagle", "eagle618/deepseek-v3-random",
          "eagle618/eagle-deepseek-v3-random", 1), False, False),
    ],
    ids=[
        "qwen3_eagle3",
        "qwen2_5_vl_eagle3",
