...
class FlashInferMetadataBuilder(AttentionMetadataBuilder[FlashInferMetadata]):
    ...
    def build_with_streaming(
        ...
        # print(f"[flashinfer build_with_streaming] num_reqs: {num_reqs}")
        # print(f"[flashinfer build_with_streaming] num_actual_tokens: {num_actual_tokens}")
        # print(f"[flashinfer build_with_streaming] num_decodes: {num_decodes}")
        # print(f"[flashinfer build_with_streaming] num_prefills: {num_prefills}")
        # print(f"[flashinfer build_with_streaming] num_decode_tokens: {num_decode_tokens}")
        # print(f"[flashinfer build_with_streaming] num_prefill_tokens: {num_prefill_tokens}")
        # breakpoint()
