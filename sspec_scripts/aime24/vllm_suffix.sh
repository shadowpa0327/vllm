...
# Test vLLM with suffix decoding on AIME24 benchmark

set -e

echo "================================================"
echo "Testing vLLM Suffix Decoding - AIME24"
echo "================================================"
...
OUTPUT_DIR="outputs/vllm_suffix_${MODEL_NAME}_tp${TP_SIZE}_repeat${REPEAT_DATASET}_$(date +%Y%m%d_%H%M%S)"

# Test datasets
DATASETS="aime24"

# Suffix decoding parameters
SUFFIX_NUM_DRAFT_TOKENS="${SUFFIX_NUM_DRAFT_TOKENS:-5}"                  # Number of speculative tokens
...
echo "  Num speculative tokens: $SUFFIX_NUM_DRAFT_TOKENS"
...
echo "Running vLLM suffix decoding test..."
echo ""
...
if [[ "$ENABLE_NSYS_PROFILING" == "1" || "$ENABLE_NSYS_PROFILING" == "true" ]]; then
    ...
    nsys profile \
        ...
        --delay=360 \
        --duration=10 \
        -o "vllm_suffix_${MODEL_NAME}_tp${TP_SIZE}" \
        ...
        --enable_thinking \
        --vllm_enable_suffix \
        --vllm_suffix_num_speculative_tokens "$SUFFIX_NUM_DRAFT_TOKENS" \
...
echo ""
echo "================================================"
echo "vLLM suffix decoding test results saved to: $OUTPUT_DIR"
echo "================================================"
echo ""
